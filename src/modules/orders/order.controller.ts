...
export const orderController = {
  ...
  update: async (req: Request, res: Response, next: NextFunction) => {
    try {
      const result = await orderService.update(req.params.orderId as string, req.body)
      respond(res, result)
    } catch (err) {
      next(err)
    }
  ...
  updateStatus: async (req: Request, res: Response, next: NextFunction) => {
    try {
      const result = await orderService.updateStatus(req.params.orderId as string, req.body)
      respond(res, result)
    } catch (err) {
      next(err)
    }
