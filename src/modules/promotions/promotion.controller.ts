...
export const promotionController = {
  ...
  getById: async (req: Request, res: Response, next: NextFunction) => {
    try {
      const result = await promotionService.getById(req.params.promotionId as string)
      respond(res, result)
    } catch (err) { next(err) }
  },
  ...
  getBySlug: async (req: Request, res: Response, next: NextFunction) => {
    try {
      const result = await promotionService.getBySlug(req.params.slug as string)
      respond(res, result)
    } catch (err) { next(err) }
  },
  ...
  update: async (req: Request, res: Response, next: NextFunction) => {
    try {
      const result = await promotionService.update(
        req.params.promotionId as string, req.body,
      )
      respond(res, result)
    } catch (err) { next(err) }
  },
  ...
  toggle: async (req: Request, res: Response, next: NextFunction) => {
    try {
      const result = await promotionService.toggle(req.params.promotionId as string)
      respond(res, result)
    } catch (err) { next(err) }
  },
  ...
  delete: async (req: Request, res: Response, next: NextFunction) => {
    try {
      const result = await promotionService.delete(req.params.promotionId as string)
      respond(res, result)
    } catch (err) { next(err) }
  },
  ...
  uploadImages: async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const result = await promotionService.uploadImages(
        req.params.promotionId as string, files,
      )
      respond(res, result)
    } catch (err) { next(err) }
  },
  ...
  deleteImage: async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const result = await promotionService.deleteImage(
        req.params.promotionId as string, imageUrl,
      )
      respond(res, result)
    } catch (err) { next(err) }
  },
