  ...
  describe("create", () => {
    ...
    it("should throw 503 if payment method is unavailable (STRIPE)", async () => {
      await expect(
        ...
        new AppError("Stripe payment is not available yet. Coming soon.", 503),
      );
    });
    ...
    it("should throw 503 if payment method is unavailable (PAYPAL)", async () => {
      await expect(
        ...
        new AppError("PayPal payment is not available yet. Coming soon.", 503),
      );
    });
    ...
    it("should throw 503 if payment method is unavailable (CINETPAY)", async () => {
      await expect(
        ...
        new AppError(
          "CinetPay payment is not available yet. Coming soon.",
          503,
        ),
      );
    });
